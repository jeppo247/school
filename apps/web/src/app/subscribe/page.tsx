      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-[#4F8CF7] text-white rounded-3xl p-8 shadow-xl shadow-blue-200/50"
          >
            ...
            <motion.button
              ...
              className="w-full bg-white text-[#4F8CF7] font-semibold py-4 rounded-xl shadow-md hover:bg-blue-50 transition-all disabled:opacity-50"
          ...
          >
            ...
            <div className="flex items-baseline gap-1 mb-1">
              <span className="font-display text-5xl font-bold text-gray-900">$59</span>
            ...
            <motion.button
              ...
              disabled={loading !== null}
              className="w-full bg-[#4F8CF7] text-white font-semibold py-4 rounded-xl hover:bg-[#3A6CD4] transition-all disabled:opacity-50"
              whileHover={{ scale: 1.01 }}
              whileTap={{ scale: 0.99 }}
            >
