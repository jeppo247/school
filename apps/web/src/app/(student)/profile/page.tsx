    ...
    <main className="min-h-screen bg-[var(--theme-bg)] pb-24">
      ...
      <div className="max-w-2xl mx-auto px-6 space-y-6">
        ...
        <div className="bg-[var(--theme-surface)] rounded-3xl p-6 border border-gray-100 text-center">
          ...
          <h2 className="font-display text-xl font-bold text-gray-800 mb-1">Indigo</h2>
        ...
        <div className="bg-[var(--theme-surface)] rounded-3xl p-6 border border-gray-100">
          ...
          <div className="flex flex-wrap gap-2">
            {["AFL", "Animals", "Space", "Cooking", "Music", "Art", "Gaming", "Nature"].map((interest) => (
              <button
                key={interest}
                className="px-4 py-2 rounded-full bg-gray-100 text-sm font-medium text-gray-600 hover:bg-[var(--theme-primary)]/10 hover:text-[var(--theme-primary)] transition-colors"
              >
                {interest}
              </button>
            ))}
