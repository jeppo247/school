...
const year1Nodes: SkillNodeSeed[] = [
  // Number and place value
  {
    ...
    yearLevel: 1, strand: "number_algebra", subStrand: "number_place_value",
  ...
  // Fractions
  {
    ...
    yearLevel: 1, strand: "number_algebra", subStrand: "fractions_decimals",
  ...
  // Money
  {
    ...
    yearLevel: 1, strand: "number_algebra", subStrand: "money_financial",
  ...
  // Patterns
  {
    ...
    yearLevel: 1, strand: "number_algebra", subStrand: "patterns_algebra",
...
const year2Nodes: SkillNodeSeed[] = [
  // Number and place value
  {
    ...
    yearLevel: 2, strand: "number_algebra", subStrand: "number_place_value",
  ...
  // Fractions
  {
    ...
    yearLevel: 2, strand: "number_algebra", subStrand: "fractions_decimals",
  ...
  // Money
  {
    ...
    yearLevel: 2, strand: "number_algebra", subStrand: "money_financial",
  ...
  // Patterns
  {
    ...
    yearLevel: 2, strand: "number_algebra", subStrand: "patterns_algebra",
...
const year3Nodes: SkillNodeSeed[] = [
  // Number and place value
  {
    ...
    yearLevel: 3, strand: "number_algebra", subStrand: "number_place_value",
  ...
  // Fractions
  {
    ...
    yearLevel: 3, strand: "number_algebra", subStrand: "fractions_decimals",
  ...
  // Money
  {
    ...
    yearLevel: 3, strand: "number_algebra", subStrand: "money_financial",
  ...
  // Patterns
  {
    ...
    yearLevel: 3, strand: "number_algebra", subStrand: "patterns_algebra",
...
const year4Nodes: SkillNodeSeed[] = [
  // Number and place value
  {
    ...
    yearLevel: 4, strand: "number_algebra", subStrand: "number_place_value",
  ...
  // Fractions and decimals
  {
    ...
    yearLevel: 4, strand: "number_algebra", subStrand: "fractions_decimals",
  ...
  // Money
  {
    ...
    yearLevel: 4, strand: "number_algebra", subStrand: "money_financial",
  ...
  // Patterns
  {
    ...
    yearLevel: 4, strand: "number_algebra", subStrand: "patterns_algebra",
